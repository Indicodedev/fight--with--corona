...
var shootingSND,gameOverSND,dieSND;
...
shootingSND = loadSound("sound/laser.mp3");
gameOverSND = loadSound("sound/game over.wav");
dieSND = loadSound("sound/die.mp3");
...
function draw()
{
  ...
  text("you are infected",290,280);
  text("wear mask to protect yourself and others",150,310);
